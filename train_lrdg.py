...
if __name__ == "__main__":
    ...
    F_nets = [copy.deepcopy(net) for e in args.src_list] # it will create 4 resnets as per the number of domains
    ...
    F_nets = [anet.to(device) for anet in F_nets] #4 trained (train_ds.py) domain sepecific classsifier
    F_cla_net.to(device)
